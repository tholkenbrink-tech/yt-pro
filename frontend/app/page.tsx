...
export default function HomePage() {
  ...
  return (
    <main className="mx-auto max-w-lg pb-4 pt-6">
      <LegalNoticeModal />
      <h1 className="mb-4 px-4 text-2xl font-bold">yt-pro</h1>
      ...
      <div className="mx-4 mb-3">
        ...
        <textarea
          ...
          className="w-full rounded-lg border border-gray-300 bg-white p-3 text-base dark:border-gray-700 dark:bg-gray-900"
        />
      </div>
      ...
      <div className="mx-4 mb-3 flex gap-2">
        <button
          ...
          className="flex-1 rounded-lg border border-gray-300 px-4 py-3 font-medium dark:border-gray-700"
        >
          Link einfügen
        </button>
        <button
          ...
          onClick={analyze}
          disabled={loading}
          className="flex-1 rounded-lg bg-brand px-4 py-3 font-medium text-white disabled:opacity-50 dark:bg-brand-dark dark:text-gray-950"
        >
      ...
      {lastQuality && (
        <p className="mx-4 mb-3 text-xs text-gray-500 dark:text-gray-400">
          Zuletzt verwendete Qualität: {lastQuality}
        </p>
      )}

      {error && (
        <p className="mx-4 mb-3 text-sm text-red-600 dark:text-red-400">{error}</p>
      )}
